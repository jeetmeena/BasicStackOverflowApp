...
@Entity(tableName = "TagForth")
public  class TagForth {
    ...
    public TagForth(@NonNull String qutionTitle, String qutionLink, @NonNull Boolean isAnswered, @NonNull String answerCount, @NonNull String typesActivit) {
