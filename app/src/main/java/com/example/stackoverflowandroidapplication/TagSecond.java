...
public  class TagSecond {
    ...
    public TagSecond(@NonNull String qutionTitle, String qutionLink, @NonNull Boolean isAnswered, @NonNull String answerCount, @NonNull String typesActivit) {
