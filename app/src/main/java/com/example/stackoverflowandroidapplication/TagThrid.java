...
class TagThrid {
    ...
    public TagThrid(@NonNull String qutionTitle, String qutionLink, @NonNull Boolean isAnswered, @NonNull String answerCount, @NonNull String typesActivit) {
